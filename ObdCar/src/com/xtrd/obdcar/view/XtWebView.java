...
public class XtWebView extends WebView {

	private int currentY = 0;

	public XtWebView(Context context) {
		super(context);
		init(context);
	}

	public XtWebView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public XtWebView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
