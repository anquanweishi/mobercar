 ...
 *
 */
public class ViolationProvinceAdapter extends BaseAdapter  implements SectionIndexer{

	private ArrayList<ViolationCity> mList = null;
	private Context mContext = null;
	public ViolationProvinceAdapter(Context con,ArrayList<ViolationCity> list){
		this.mList = list;
		this.mContext = con;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.tvLetter.setText(info.getProvince());
