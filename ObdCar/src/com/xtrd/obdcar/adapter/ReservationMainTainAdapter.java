 ...
 *
 */
public class ReservationMainTainAdapter extends BaseAdapter {
	
	private Context context;
	private ArrayList<MainTainChildItem> list;

	public ReservationMainTainAdapter(Context context,ArrayList<MainTainChildItem> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.layout_maintain_item_for_reservation, null);
