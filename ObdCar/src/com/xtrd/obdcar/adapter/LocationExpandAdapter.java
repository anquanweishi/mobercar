...
public class LocationExpandAdapter extends BaseExpandableListAdapter {
	...
	private List<ObdLocation> mList = null;
	private Context mContext = null;
	public LocationExpandAdapter(Context con,ArrayList<ObdLocation> list){
		this.mList = list;
		this.mContext = con;
	}

	@Override
	public ObdLocation getChild(int groupPosition, int childPosition) {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		ObdLocation location = mList.get(groupPosition).getList().get(childPosition);
		...
		viewHolder.text_title.setText(location.getDisplayName());
		return convertView;
	}
	...
	@Override
	public ObdLocation getGroup(int groupPosition) {
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		ObdLocation location = mList.get(groupPosition);
		View view = null;
		...
		holder.title_text.setText(location.getDisplayName());
