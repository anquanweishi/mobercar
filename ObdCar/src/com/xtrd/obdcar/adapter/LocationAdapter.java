...
public class LocationAdapter extends BaseAdapter  implements SectionIndexer{
	...
	private ArrayList<ObdLocation> mList = null;
	private Context mContext = null;
	public LocationAdapter(Context con,ArrayList<ObdLocation> list){
		this.mList = list;
		this.mContext = con;
	}
	...
	@Override
	public ObdLocation getItem(int position) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		final ObdLocation info = getItem(position);
		if (convertView == null) {
		...
		viewHolder.tvLetter.setText(info.getDisplayName());
	...
	public int getSectionForPosition(int position) {
		if(getItem(position).getSortLetters()!=null) {
