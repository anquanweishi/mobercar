...
import com.xtrd.obdcar.adapter.AddOilAdapter;
...
//		mMapView = (MapView)findViewById(R.id.bmapView);
		...
		if(SettingLoader.getCarLatLng(this)==null) {
			...
			XtrdApp.getInstance().getCurrentLocation(new XtrdApp.LocationCallBack(){
				...
				public void callback(double longitude, double latitude,
					...
					NetRequest.requestUrl(AddOilActivity.this, ApiConfig.getRequestUrl(ApiConfig.Subscrption_Url), params, new NetRequest.NetCallBack() {
	...
	private void updateUI() {
		...
		if(list==null||list.size()==0) {
			...
			if(adapter==null) {
				adapter = new AddOilAdapter(this, list,new AddOilAdapter.ClickCallback() {
