...
public class InsuranceActivity extends BaseActivity {
	...
	public InsuranceActivity() {
		layout_id = R.layout.activity_insurance;
	}
	
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		initTitle(0, R.drawable.btn_back_bg,R.string.title_insure, 0,0);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Utils.showPhoneTips(InsuranceActivity.this, hotLine.getTelephone());
			}
		});
	...
	private void getInsurance() {
		...
		fh.post(ApiConfig.getRequestUrl(ApiConfig.Car_Insurance_Company_URL) ,params, new AjaxCallBack<String>() {
						...
						if("<".equals(String.valueOf(t.charAt(0)))) {
							...
							if(json.has("status")) {
								...
								if(1==status) {
									...
									Utils.showToast(InsuranceActivity.this, msg);
								}
							}
						}
					}
