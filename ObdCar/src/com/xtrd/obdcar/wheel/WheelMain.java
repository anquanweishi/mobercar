...
public class WheelMain {
	...
	public WheelMain(View view,boolean hasDay,boolean hasSelectTime) {
		super();
		this.view = view;
		this.hasSelectTime = hasSelectTime;
		this.hasDay = hasDay;
...
//		int day = calendar.get(Calendar.DATE);
	...
	public String getTime() {
		...
		if(!hasDay&&!hasSelectTime) {
			sb.append((wv_year.getCurrentItem() + START_YEAR)).append("-")
			.append((wv_month.getCurrentItem() + 1)<10?("0"+(wv_month.getCurrentItem() + 1)):(wv_month.getCurrentItem() + 1));
		}else {
			if(!hasSelectTime) {
				sb.append((wv_year.getCurrentItem() + START_YEAR)).append("-")
					.append((wv_month.getCurrentItem() + 1)<10?("0"+(wv_month.getCurrentItem() + 1)):(wv_month.getCurrentItem() + 1)).append("-")
					.append((wv_day.getCurrentItem() + 1)<10?("0"+(wv_day.getCurrentItem() + 1)):(wv_day.getCurrentItem() + 1));
			}else {
				sb.append((wv_year.getCurrentItem() + START_YEAR)).append("-")
				.append((wv_month.getCurrentItem() + 1)<10?("0"+(wv_month.getCurrentItem() + 1)):(wv_month.getCurrentItem() + 1)).append("-")
